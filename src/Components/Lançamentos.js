				...
				<View style={styles.barraBg}>
					<View style={styles.barra}>
						...
						<TouchableOpacity
							...
							<Text style={styles.textoAtual}>Lançamentos</Text>
						</TouchableOpacity>
				...
				<View style={styles.containerAnimes}>
					<View style={styles.containerAnimesBG}>
						<View
							...
							<Image
								source={require('../Images/lança1.png')}
								style={styles.imageA}
							/>
							<Text style={styles.textoAnime}> Tower of gods </Text>
						</View>
					</View>
				</View>
				...
				<View style={styles.containerAnimes}>
					<View style={styles.containerAnimesBG}>
						<View
							...
							<Image
								source={require('../Images/lança2.png')}
								style={styles.imageA}
							/>
							<Text style={styles.textoAnime}>God of High School</Text>
						</View>
					</View>
				</View>
				...
				<View style={styles.containerAnimes}>
					<View style={styles.containerAnimesBG}>
						<View
							...
							<Image
								source={require('../Images/lança3.png')}
								style={styles.imageA}
							/>
							<Text style={styles.textoAnime}> Jujutsu Kaisen </Text>
						</View>
					</View>
				</View>
